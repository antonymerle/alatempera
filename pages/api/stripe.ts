  ...
  if (req.method === "POST") {
    ...
    try {
      ...
      const params = {
        ...
        success_url: `${process.env.BASE_DOMAIN_URL}/success2?session_id={CHECKOUT_SESSION_ID}`, // CHECKOUT_SESSION_ID to get customer details https://stripe.com/docs/payments/checkout/custom-success-page
